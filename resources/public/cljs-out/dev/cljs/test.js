...
var G__10970 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__10970,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__10970;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq10972){
var G__10973 = cljs.core.first.call(null,seq10972);
var seq10972__$1 = cljs.core.next.call(null,seq10972);
var G__10974 = cljs.core.first.call(null,seq10972__$1);
var seq10972__$2 = cljs.core.next.call(null,seq10972__$1);
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__10979,map__10979__$1,file,line,column){
return (function (p1__10978_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__10978_SHARP_));
});})(map__10979,map__10979__$1,file,line,column))
...
var temp__5457__auto___10981 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___10981)){
var message_10982 = temp__5457__auto___10981;
cljs.core.println.call(null,message_10982);
} else {
}
...
var temp__5457__auto___10983 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___10983)){
var message_10984 = temp__5457__auto___10983;
cljs.core.println.call(null,message_10984);
} else {
}
...
var output_dir__$1 = (function (){var G__10985 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10985),"/"].join('');
} else {
return G__10985;
}
})();
...
var G__10987 = exception.stack;
var G__10987__$1 = (((G__10987 == null))?null:clojure.string.split_lines.call(null,G__10987));
var G__10987__$2 = (((G__10987__$1 == null))?null:cljs.core.get.call(null,G__10987__$1,depth));
if((G__10987__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__10987__$2);
}
} else {
...
var vec__10988 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__10988,(0),null);
var column = cljs.core.nth.call(null,vec__10988,(1),null);
var vec__10991 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__10991,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__10991,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__10991,(2),null);
...
var m__$1 = (function (){var G__10994 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__10998 = (function (){var G__10997 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__10997);
} else {
return G__10997;
}
})();
...
return cljs.core.vary_meta.call(null,G__10999,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__11003 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__11003,(0),null);
var types = vec__11003;
...
return cljs.core.map.call(null,(function (p__11006){
var vec__11007 = p__11006;
var ns = cljs.core.nth.call(null,vec__11007,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__11007,(1),null);
return ((function (vec__11007,ns,vars__$1){
return (function (){
...
var G__11010 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__11010,G__11010__$1,env,once_fixtures,each_fixtures,vec__11007,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__11010,G__11010__$1,env,once_fixtures,each_fixtures,vec__11007,ns,vars__$1){
return (function (){
var seq__11011 = cljs.core.seq.call(null,vars__$1);
var chunk__11012 = null;
var count__11013 = (0);
var i__11014 = (0);
while(true){
if((i__11014 < count__11013)){
var v = cljs.core._nth.call(null,chunk__11012,i__11014);
var temp__5457__auto___11016 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___11016)){
var t_11017 = temp__5457__auto___11016;
each_fixture_fn.call(null,((function (seq__11011,chunk__11012,count__11013,i__11014,t_11017,temp__5457__auto___11016,v,each_fixture_fn,G__11010,G__11010__$1,env,once_fixtures,each_fixtures,vec__11007,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_11017)));
});})(seq__11011,chunk__11012,count__11013,i__11014,t_11017,temp__5457__auto___11016,v,each_fixture_fn,G__11010,G__11010__$1,env,once_fixtures,each_fixtures,vec__11007,ns,vars__$1))
);
} else {
}


var G__11018 = seq__11011;
var G__11019 = chunk__11012;
var G__11020 = count__11013;
var G__11021 = (i__11014 + (1));
seq__11011 = G__11018;
chunk__11012 = G__11019;
count__11013 = G__11020;
i__11014 = G__11021;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__11011);
if(temp__5457__auto__){
var seq__11011__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__11011__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__11011__$1);
var G__11022 = cljs.core.chunk_rest.call(null,seq__11011__$1);
var G__11023 = c__4351__auto__;
var G__11024 = cljs.core.count.call(null,c__4351__auto__);
var G__11025 = (0);
seq__11011 = G__11022;
chunk__11012 = G__11023;
count__11013 = G__11024;
i__11014 = G__11025;
continue;
} else {
var v = cljs.core.first.call(null,seq__11011__$1);
var temp__5457__auto___11026__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___11026__$1)){
var t_11027 = temp__5457__auto___11026__$1;
each_fixture_fn.call(null,((function (seq__11011,chunk__11012,count__11013,i__11014,t_11027,temp__5457__auto___11026__$1,v,seq__11011__$1,temp__5457__auto__,each_fixture_fn,G__11010,G__11010__$1,env,once_fixtures,each_fixtures,vec__11007,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_11027)));
});})(seq__11011,chunk__11012,count__11013,i__11014,t_11027,temp__5457__auto___11026__$1,v,seq__11011__$1,temp__5457__auto__,each_fixture_fn,G__11010,G__11010__$1,env,once_fixtures,each_fixtures,vec__11007,ns,vars__$1))
);
} else {
}


var G__11028 = cljs.core.next.call(null,seq__11011__$1);
var G__11029 = null;
var G__11030 = (0);
var G__11031 = (0);
seq__11011 = G__11028;
chunk__11012 = G__11029;
count__11013 = G__11030;
i__11014 = G__11031;
continue;
}
} else {
...
});})(each_fixture_fn,G__11010,G__11010__$1,env,once_fixtures,each_fixtures,vec__11007,ns,vars__$1))
);
});})(each_fixture_fn,G__11010,G__11010__$1,env,once_fixtures,each_fixtures,vec__11007,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__11010__$1)].join('')));

}
})());
});
;})(vec__11007,ns,vars__$1))
