...
var len__4531__auto___11074 = arguments.length;
var i__4532__auto___11075 = (0);
while(true){
if((i__4532__auto___11075 < len__4531__auto___11074)){
args__4534__auto__.push((arguments[i__4532__auto___11075]));

var G__11076 = (i__4532__auto___11075 + (1));
i__4532__auto___11075 = G__11076;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs_test_display.core.n.cljs$lang$applyTo = (function (seq11071){
var G__11072 = cljs.core.first.call(null,seq11071);
var seq11071__$1 = cljs.core.next.call(null,seq11071);
var G__11073 = cljs.core.first.call(null,seq11071__$1);
var seq11071__$2 = cljs.core.next.call(null,seq11071__$1);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11072,G__11073,seq11071__$2);
});
...
var vec__11077 = ((clojure.string.starts_with_QMARK_.call(null,cljs.core.first.call(null,classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,cljs.core.first.call(null,classes),(1)),cljs.core.rest.call(null,classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.call(null,vec__11077,(0),null);
var classes__$1 = cljs.core.nth.call(null,vec__11077,(1),null);
var G__11080 = cljs.core.PersistentArrayMap.EMPTY;
var G__11080__$1 = (cljs.core.truth_(id)?cljs.core.assoc.call(null,G__11080,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__11080);
if(cljs.core.truth_(cljs.core.not_empty.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__11080__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",classes__$1));
} else {
return G__11080__$1;
}
} else {
...
return (function() { 
var G__11084__delegate = function (klass,contents){
var vec__11081 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons.call(null,klass,contents)], null));
var klass__$1 = cljs.core.nth.call(null,vec__11081,(0),null);
var contents__$1 = cljs.core.nth.call(null,vec__11081,(1),null);
...
var G__11084 = function (klass,var_args){
var contents = null;
if (arguments.length > 1) {
var G__11085__i = 0, G__11085__a = new Array(arguments.length -  1);
while (G__11085__i < G__11085__a.length) {G__11085__a[G__11085__i] = arguments[G__11085__i + 1]; ++G__11085__i;}
  contents = new cljs.core.IndexedSeq(G__11085__a,0,null);
} 
return G__11084__delegate.call(this,klass,contents);};
G__11084.cljs$lang$maxFixedArity = 1;
G__11084.cljs$lang$applyTo = (function (arglist__11086){
var klass = cljs.core.first(arglist__11086);
var contents = cljs.core.rest(arglist__11086);
return G__11084__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__11090){
...
var ns = cljs.core.get.call(null,map__11091__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__11093){
...
var actual = cljs.core.get.call(null,map__11094__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.call(null,map__11094__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__11096){
...
var expected = cljs.core.get.call(null,map__11097__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.call(null,map__11097__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
return cljs.core.cons.call(null,new_current_node,p1__11099_SHARP_);
...
var curr_node = cljs_test_display.core.current_node.call(null);
var map__11101 = cljs_test_display.core.current_var_info.call(null);
...
var info = map__11101__$1;
var name = cljs.core.get.call(null,map__11101__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.call(null,map__11101__$1,new cljs.core.Keyword(null,"line","line",212345235));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),((function (curr_node,map__11101,map__11101__$1,info,name,line,file,node){
return (function (p1__11100_SHARP_){
return cljs.core.cons.call(null,node,p1__11100_SHARP_);
});})(curr_node,map__11101,map__11101__$1,info,name,line,file,node))
);

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__11103){
...
var m = map__11104__$1;
var fail = cljs.core.get.call(null,map__11104__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.call(null,map__11104__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.call(null,map__11104__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.call(null,map__11104__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
var temp__5457__auto___11106 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___11106)){
var message_11107 = temp__5457__auto___11106;
cljs.core.println.call(null,message_11107);
} else {
}
...
var temp__5457__auto___11108 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___11108)){
var message_11109 = temp__5457__auto___11108;
cljs.core.println.call(null,message_11109);
} else {
}
