...
return cljs.core.map.call(null,(function (p1__11060_SHARP_){
return html_coll.item(p1__11060_SHARP_);
...
return cljs.core._EQ_.call(null,"icon",p1__11061_SHARP_);
...
var ctx_11062 = cvs.getContext("2d");
ctx_11062.fillStyle = color;

ctx_11062.fillRect((0),(0),size,size);
